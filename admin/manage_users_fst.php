...
if (!$rr) {
  echo "<h2 style='color:red;color:#ff0000;font-family:Acme;position:relative;top:35px;left:30%;''>No Students have Registered For Fastrack Exams Yet.</h2>";
} else {
?>
  ...
  <body>
    ...
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class="page-header"><u>Students Registered For Fastrack :</u></h2>
