...
?>
    ...
    <script>
      function DeleteUser(id) {
        if (confirm("Are You Sure..? You Want To Delete this Subject...?")) {
          window.location.href = "delete_s5.php?id=" + id;
        }
      }
    </script>
    <style type="text/css">
  ...
  <body>
    ...
    <br /><br /><br /><br /><br /><br />
    <h2 style="color:#ff0000;font-family:'Acme';" class="page-header">5th Sem Subjects</h2>
    ...
    <div class="col-lg-10 mcon text-center">
      <table id="mytab1" width="100%" class="mtab table table-bordered table-hover table-responsive" style="margin-top:0;">
        ...
        ?>
          <td align='center' style='border:2px solid black'> <a href="update_s5.php?id=<?php echo $row['id']; ?>" style='color:green'><i class="fas fa-pencil-alt"></i></a> </td>
