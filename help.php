...
<body>
  ...
  <div class="col-lg-6 m-auto mcon" style="border-radius: none;">
    ...
    <p align="center" style="padding-left:5px;text-shadow: 0.5px 0.5px black;padding-right: 10px;
      ...
      3. After Registering Go To Login Page & <br /> 4. Enter The Login Details Which You Have Set During the time of
      Registration.<br />
    ...
    <p align="left" style="padding-left:5px;color:black;text-shadow: 0.5px 0.5px black;padding-right: 10px;font-size:20px;text-align:justify;">
      Who don't have year back <br />
      <br />


    <h4 style="text-shadow: 0.5px 0.5px black;padding-right: 10px;"> NOTE: CANNOT REGISTER FOR FASTTRACK EXAM BEFORE SEE
    </h4>
    <p style="text-shadow: 0.5px 0.5px black;padding-right: 10px;margin-bottom:0%;">LINK FOR FASTTRACK WILL BE AVAILABLE
      IN JUNE 2020 (After Even Sem)</p><br />
    <br />
  </div>
  <!--Scroll Up js File-->
